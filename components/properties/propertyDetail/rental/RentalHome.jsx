...
import RentalGlance from "./RentalGlance";
import RentalPricingPlans from "./RentalPricingPlans";
import { getRentalDetailAdapter } from "./rentalDetailAdapter";

export default function RentalHome({ property }) {
        ...
        <div className="row">
          <div className="col-xl-8 col-lg-7">
            <div id="property-overview-section" className="wg-property box-property-detail">
              <RentalGlance property={detailData} />
            </div>
            ...
            <div id="floor-plan-section" className="wg-property single-property-floor">
              <RentalPricingPlans property={detailData} />
            </div>
