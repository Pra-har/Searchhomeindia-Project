...
import PlotGlance from "./PlotGlance";
import PlotPricingPlans from "./PlotPricingPlans";
import { getPlotDetailAdapter } from "./plotDetailAdapter";

export default function PlotHome({ property }) {
        ...
        <div className="row">
          <div className="col-xl-8 col-lg-7">
            <div id="property-overview-section" className="wg-property box-property-detail">
              <PlotGlance property={detailData} />
            </div>
            ...
            <div id="floor-plan-section" className="wg-property single-property-floor">
              <PlotPricingPlans property={detailData} />
            </div>
