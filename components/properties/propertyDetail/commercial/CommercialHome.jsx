...
import CommercialGlance from "./CommercialGlance";
import CommercialPricingPlans from "./CommercialPricingPlans";
import { getCommercialDetailAdapter } from "./commercialDetailAdapter";

export default function CommercialHome({ property }) {
        ...
        <div className="row">
          <div className="col-xl-8 col-lg-7">
            <div id="property-overview-section" className="wg-property box-property-detail">
              <CommercialGlance property={detailData} />
            </div>
            ...
            <div id="floor-plan-section" className="wg-property single-property-floor">
              <CommercialPricingPlans property={detailData} />
            </div>
            ...
            <div id="project-connectivity-section" className="wg-property box-project-connectivity">
              <ProjectConnectivity property={detailData} />
            </div>
