        ...
        <div className="widget-range mb-30">
          <div className="box-title-price mb-10">
            <div className="caption-price text-12">
              <span>
                Price: ${formatNumber(priceRange[0])} - $
      ...
      <div className="sidebar-item sidebar-location">
        <div className="wrap-box-location">
          <a className="box-location style-2 hover-img-rotate">
            ...
            <div className="content">
              <h6 className="text_white text-1 lh-20">Bangalore</h6>
          ...
          <a className="box-location style-2 hover-img-rotate">
            ...
            <div className="content">
              <h6 className="text_white text-1 lh-20">Mumbai</h6>
              <p className="text-2">1570 listing</p>
            </div>
          </a>
          <a className="box-location style-2 hover-img-rotate">
            ...
            <div className="content">
              <h6 className="text_white text-1 lh-20">Delhi</h6>
              <p className="text-2">1570 listing</p>
            </div>
          </a>
          <a className="box-location style-2 hover-img-rotate">
            ...
            <div className="content">
              <h6 className="text_white text-1 lh-20">Hyderabad</h6>
              <p className="text-2">1570 listing</p>
            </div>
          </a>
          <a className="box-location style-2 hover-img-rotate">
            ...
            <div className="content">
              <h6 className="text_white text-1 lh-20">Pune</h6>
              <p className="text-2">1570 listing</p>
            </div>
          </a>
          <a className="box-location style-2 hover-img-rotate">
            ...
            <div className="content">
              <h6 className="text_white text-1 lh-20">Chennai</h6>
              <p className="text-2">1570 listing</p>
            </div>
          </a>
        </div>
