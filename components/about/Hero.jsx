...
export default function Hero() {
  return (
    <div className="page-title home07 tf-spacing-7">
      <div className="tf-container xl">
        <div className="row">
          <div className="col-12">
            <div className="text-uppercasetext-color-heading text-center" style={{marginBottom: 12}}>
             <span style={{color:"#1b6c9f", fontWeight: 600, fontSize: 22}}> Welcome  to </span> 
            </div>
            <div className="clip-color-text heading">
              <div className="clip-text-bg-Horizontal" id="scrollText">
               <h1> Search Homes India </h1>
              </div>
            </div>
